...
from .make_item import construct_ml_model_properties, construct_assets, create_pystac_item
...
download_js_file_path = os.path.join(os.path.dirname(__file__), 'js', 'download_to_file.js')
download_js = None
...
def button_bar(session):
    ...
    return Div(
        Button("Reset", hx_post='/clear_form', hx_target="#result", hx_swap="innerHTML"),
